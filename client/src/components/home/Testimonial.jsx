...
const Testimonial = () => {
    ...
    return (
        ...
        `}</style>
            ...
            <div div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12' >
                <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-5 py-1.5">
                    <BookUserIcon className='size-4 stroke-green-600' />
                    <span>Testimonials</span>
                </div>
                <Title title="Don't just take our words" description='Hear from our satisfied customers about the benefits of using our AI-powered resume builder.' />
            </div >
