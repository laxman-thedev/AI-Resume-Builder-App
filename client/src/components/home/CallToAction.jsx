...
const CallToAction = () => {
    return (
        <div id='contact' class="border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-16 mt-28">
            <div class="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8 px-3 md:px-10 border-x border-dashed border-slate-200 py-20 -mt-10 -mb-10 w-full">
                <p class="text-xl font-medium max-w-sm"><span class="text-green-600">Get started today</span> and start building your resume today.</p>
