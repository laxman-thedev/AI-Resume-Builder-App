 ...
 * Features Component
 * ------------------
 * Displays the feature section on the home page.
 * Highlights key benefits of the resume builder with visuals and icons.
 */
const Features = () => {
    // Tracks hover state for the first feature card
    ...
    return (
        ...
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            {/* Local font override for this section */}
            <style>{`
