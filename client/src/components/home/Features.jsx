...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build your resume' description='Our AI-powered resume builder is easy to use and intuitive. Simply upload your resume and start customizing your profile.' />
